...
@section('content')
    <div class="content">
        ...
        <hr/>
        <p style="padding:1vw; line-height:150%; word-break:keep-all;">
        ...
        <div style="width: 100%; display: inline-block; text-align: left; border: 1px solid black;">
            @forelse($data as $value)
                <div class="consulting_data" onclick="location.href='{{url('consulting_filedownload/'.$value->consulting_id)}}'">
                    <div style="width:100%; height:10%;"><img src="img/document.png" style="width:100%; height:100%;"></div>
                    <div>{{$value->consulting_title}}</div>
                </div>
                @empty

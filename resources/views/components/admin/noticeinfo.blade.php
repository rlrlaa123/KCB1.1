<div class="sidebar noticeinfo {{preg_match('/\/admin\/notice/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/notice.+/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/fyi/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/fyi.+/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/consulting/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/consulting.+/', $_SERVER['REQUEST_URI'])? '' :'hide'}}">

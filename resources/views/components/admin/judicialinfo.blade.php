...
|| preg_match('/\/admin\/policy/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/policy.+/', $_SERVER['REQUEST_URI'])
|| preg_match('/\/admin\/relatednews/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/relatednews.+/', $_SERVER['REQUEST_URI']) ? '' : 'hide'}}">
    ...
    <div class="sidesubmenu">
        <ul>
            ...
            <li class="selector  {{ preg_match('/\/admin\/relatednews/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/relatednews.+/', $_SERVER['REQUEST_URI']) ? 'active' : ''}}">

...
@section('content')
    <title>(주)한국보상원 회사소개</title>
    <div class="introbody">

        <div class="left grid-item">
            <h2>회사소개</h2>&nbsp;&nbsp;<h3>Company</h3>
            <ul>
                <li onclick="intro('introduction')">
                    <button class="intro_button">회사소개 및 대표인사말</button>
                </li>
                <li onclick="intro('business_result')">
                    <button class="intro_button">보상원 사업 실적</button>
                </li>
            </ul>
        </div>
        <div class="right grid-item">
            ...
            <div class="introductionPage" id="introduction">
                <h3>회사소개 및 대표 인사말</h3>
                <h4>새로운 창조를 위한 변화와 도전<br>
                    Change and challenge for new creation</h4>
                <img src="/img/intro.jpg" style="float:left; width:30%; margin: 1vw;">
                <div class="intro_desc">
                    <p>21세기 우리 경제는 비약적인 성장과 더불어 많은 사회문제 또한 야기 되었습니다. 특히 공익사업에 기한 손실보상 업무는 국민의 재산권 보존과 공공사업의 적기수행이라는 다소
                        양립하기 어려운 두 가지 목적을 달성해야 하기에 손실보상업무에 대한 법령과 판례가 인정하는 절차와 해석에 따라 공정하고 투명하게 수행해야함은 물론 이거니와 보상에 관한 관련
                        법령의 숙지와, 공공사업에 대한 보상 대상자의 불만을 최소화하고 첨예한 이해관계의 대립을 사전에 방지하기 위한 풍부한 경험과 축척된 지식을 갖춘 전문가가 수행해야 할
                        필요성이 대두되었습니다.
                    </p>
                    <p>저희 ㈜한국보상원은 토지보상 제도의 발전과 연구를 위해 변호사, 평가사, 세무사, 행정사, 지적기사, 공인중개사, 장례지도사 등의 전문자격사를 기반으로 2008년부터 유수의
                        공공사업 현장에서 성공적인 Project를 진행한 경험의 결실로서 탄생한 보상 전문기관입니다.
                    </p>
                    <p>특히 손실보상업무는 첨예하게 대립되는 공익과 사익을 조절하는 고도의 전문화된 업무일 뿐만 아니라 우리 국가와 같이 단기간에 폭발적인 경제성장을 이룬 국가의 경우 보상에 관한
                        법률제도가 현실에서 대두되는 문제들을 따라잡지 못한 것이 사실임으로 현장에서의 실무전문가의 역할을 더욱 크게 만들었다 할 것입니다.</p>
                    <p>이러한 시대적 요구에 힘입어 관련 법령에 대한 높은 이해와 다양한 유권해석을 통해 보다 전문적이며 작은 문제에도 항상 탐구하여 고객의 입장에서 진정성과 열정을 품고 항상

                ...
                <div class="location_class_child">
                    <div class="dev_table_child">
                        @foreach($cities as $city)
                            <div class="listed" onclick="showDistrictList('{{$city->dev_city}}')">
                                {{$city->dev_city}}
                            </div>
                        @endforeach
                    </div>
                    <div class="dev_table_child" id="district">
                        @forelse($location as $loc)
                            <div onclick="dev_district({{$loc->num_id}})" class="listed2" id="{{ $loc->num_id }}"
            ...
            <div class="search_classes">
                ...
                <div class="dev_table_child">
                    @foreach($search_type as $type)
                        <div class="listed" onclick="dev_type({{$type->search_type_id}})">
                            {{$type->search_type}}
                        </div>
                    @endforeach
                </div>
            ...
            <div class="search_classes">
                ...
                <div class="dev_table_child">
                    @foreach($search_charge as $charge)
                        <div class="listed" onclick="dev_charge({{$charge->search_charge_id}})">

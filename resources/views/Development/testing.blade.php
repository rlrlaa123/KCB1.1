...
@section('content')
    <style>
        ...
        .popprint {
            background: url(../images/pop_print_bg.gif) no-repeat
        }
        ...
        .popprint .pwrap .phead {
            height: 60px;
            margin-bottom: 40px
        }

        .popprint .pwrap .phead .ul_logo {
            padding-top: 16px;
            margin-left: 30px;
            margin-right: 10px
        }
        ...
        .big_wrap .branchwrap .liL .mapArea {
            width: 385px;
            height: 485px
        }

        .big_wrap .branchwrap .liR {
            float: left;
            width: 288px;
        }

        .big_wrap .branchwrap .liR .listdiv {
            border-top: solid 1px #66bbee;
            border-bottom: solid 1px #aaccdd;
            margin-top: 8px;
        ...
        .big_wrap .branchwrap .liR .listdiv .ulscr {
            overflow-y: scroll;
            padding: 0px 0px 0px 20px;
            height: 70px;
        }

        .big_wrap .branchwrap .liR .listdiv .ulscr li {
            padding: 1px 0px 1px 0px
        }

        .big_wrap .infobox {
            background: url(../images/big_info_bg.gif) no-repeat;
            width: 688px;
            height: 136px
        }
        ...
        .big_wrap .infobox ul li {
            line-height: 23px;
            background: url(../images/big_info_i.gif) no-repeat 0px 10px;
            padding-left: 10px
        }
        ...
        .admin_wrap .adminT .liL {
            float: left;
            padding-top: 8px
        }

        .admin_wrap .adminT .liR {
            float: right;
        }

        .admin_wrap .branchwrap {
            margin-bottom: 20px;
            height: 500px
        }

        .admin_wrap .branchwrap .liL {
            float: left;
            width: 385px;
            background-color: #999;
            margin-right: 15px
        ...
        .admin_wrap .branchwrap .liL .mapArea {
            width: 385px;
            height: 485px
        }

        .admin_wrap .branchwrap .liR {
            float: left;
            width: 385px;
        }
    ...
    <div class="content">
        ...
        <div class="map_country">
            <img src="/map/Korea.png" alt="전국지도"/>
            <ul>
                <li class="tx1_1"><a href="javascript:FindDistrict(1,'서울특별시');" class="on">서울</a></li>
                <li class="tx1_2"><a href="javascript:FindDistrict(2,'경기도');" class="">경기도</a></li>
                <li class="tx1_3"><a href="javascript:FindDistrict(3,'강원도');" class="">강원도</a></li>
                <li class="tx1_4"><a href="javascript:FindDistrict(4,'경상남도');" class="">경상남도</a></li>
                <li class="tx1_5"><a href="javascript:FindDistrict(5,'경상북도');" class="">경상북도</a></li>
                <li class="tx1_6"><a href="javascript:FindDistrict(6,'광주광역시');" class="">광주</a></li>
                <li class="tx1_7"><a href="javascript:FindDistrict(7,'대구광역시');" class="">대구</a></li>
                <li class="tx1_8"><a href="javascript:FindDistrict(8,'대전광역시');" class="">대전</a></li>
                <li class="tx1_9"><a href="javascript:FindDistrict(9,'부산광역시');" class="">부산</a></li>
                <li class="tx1_10"><a href="javascript:FindDistrict(10,'세종특별자치시');" class="">세종</a></li>
                <li class="tx1_11"><a href="javascript:FindDistrict(11,'울산광역시');" class="">울산</a></li>
                <li class="tx1_12"><a href="javascript:FindDistrict(12,'인천광역시');" class="">인천</a></li>
                <li class="tx1_13"><a href="javascript:FindDistrict(13,'전라남도');" class="">전라남도</a></li>
                <li class="tx1_14"><a href="javascript:FindDistrict(14,'전라북도');" class="">전라북도</a></li>
                <li class="tx1_15"><a href="javascript:FindDistrict(15,'제주특별자치도');" class="">제주도</a></li>
                <li class="tx1_16"><a href="javascript:FindDistrict(16,'충청남도');" class="">충청남도</a></li>
                <li class="tx1_17"><a href="javascript:FindDistrict(17,'충청북도');" class="">충청북도</a></li>
        ...
        <!--//map_country-->
        <!--sidoMap-->
        <div class="sidoMap" style="display:block;">
        ...
        <div class="sidoMap" style="display:none;">
            <img src="/map/Gangreung.png" alt="강릉"/>
            <ul>

                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_title" name="dev_title" class="form-control"
                                       ...
                                       value="{{ old('dev_title',$data->dev_title) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_initiated_log" name="dev_initiated_log" class="form-control"
                                       placeholder="추진내역을 입력해주세요." size="68"
                                       value="{{ old('dev_initiated_log',$data->dev_initiated_log)}}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" id="dev_initiated_date" name="dev_initiated_date"
                                       class="form-control" size="68"
                                       value="{{ old('dev_initiated_date', $data->dev_initiated_date) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="dev_comment" name="dev_comment" class="form-control"
                                          ...
                                          cols="70">{{ old('dev_comment',$data->dev_comment) }}</textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="dev_area_size" name="dev_area_size"
                                       class="form-control" size="68"
                                       value="{{ old('dev_area_size', $data->dev_area_size) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_method" name="dev_method" class="form-control"
                                       placeholder="사업방식을 입력해주세요." size="68"
                                       value="{{ old('dev_method',$data->dev_method) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_applied_law" name="dev_applied_law" class="form-control"
                                       placeholder="적용법률을 입력해주세요." size="68"
                                       value="{{ old('dev_applied_law',$data->dev_applied_law) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" id="dev_publicly_starting_date" name="dev_publicly_starting_date"
                                       class="form-control"
                                       value="{{ old('dev_publicly_starting_date', $data->dev_publicly_starting_date) }}">

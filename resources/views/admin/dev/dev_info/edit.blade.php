            ...
            <form id="development-form" method="POST" action="{{ route('admin.dev.update', $data->dev_id) }}"
                ...
                <div class="row">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_title" name="dev_title" class="form-control"
                                       placeholder="제목을 입력해주세요." size="68" value="{{ old('dev_title',$data->dev_title) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_initiated_log" name="dev_initiated_log" class="form-control"
                                       placeholder="추진내역을 입력해주세요." size="68" value="{{ old('dev_initiated_log',$data->dev_initiated_log)}}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" id="dev_initiated_date" name="dev_initiated_date"
                                       class="form-control" size="68" value="{{ old('dev_initiated_date', $data->dev_initiated_date) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="dev_comment" name="dev_comment" class="form-control"
                                          placeholder="COMMENT를 입력해주세요." cols="70">{{ old('dev_comment',$data->dev_comment) }}</textarea>
                        ...
                        <tr>
                            <td class="datainput"><label for="dev_city">시/도</label><label for="dev_district">군/구 {{ old('dev_district', $data->dev_district) }}</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="datainput"><label for="dev_type">유형 {{old('dev_type',$data->dev_type)}}</label></td>
                            <td>
                                <select id="dev_type" name="dev_type" form="development-form">
                                    @foreach($searchtype as $type)
                                        <option value={{ $type->search_type }} @if($data->dev_type == $type->search_type) selected @endif>{{ old('search_type',$type->search_type) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <td>
                                <select id="dev_charge" name="dev_charge" form="development-form">
                                    @foreach($searchcharge as $charge)
                                        <option value={{ $charge->search_charge }} @if($data->dev_charge == $charge->search_charge) selected @endif>{{ old('search_charge',$charge->search_charge) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="dev_area_size" name="dev_area_size"
                                       class="form-control" size="68" value="{{ old('dev_area_size', $data->dev_area_size) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_method" name="dev_method" class="form-control"
                                       placeholder="사업방식을 입력해주세요." size="68" value="{{ old('dev_method',$data->dev_method) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="dev_applied_law" name="dev_applied_law" class="form-control"
                                       placeholder="적용법률을 입력해주세요." size="68" value="{{ old('dev_applied_law',$data->dev_applied_law) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" id="dev_publicly_starting_date" name="dev_publicly_starting_date"
                                       class="form-control" value="{{ old('dev_publicly_starting_date', $data->dev_publicly_starting_date) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="dev_future_plan" name="dev_future_plan" class="form-control"
                                          ...
                                          cols="70">{{ old('dev_future_plan',$data->dev_future_plan) }}</textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="file" id="dev_fileimage" name="dev_fileimage" class="image"
                                       value="{{ old('dev_fileimage',$data->dev_fileimage) }}">

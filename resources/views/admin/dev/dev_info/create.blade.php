                ...
                <div class="row">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="dev_comment" name="dev_comment" class="form-control"
                                          placeholder="COMMENT를 입력해주세요." cols="70"></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="dev_city" name="dev_city" form="development-form" onchange="showDistrictList(value)">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="dev_area_size" name="dev_area_size"
                                       class="form-control" size="68" placeholder="면적을 입력해주세요.">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="file" id="dev_fileimage" name="dev_fileimage" class="image" value=1>

...
@section('content')
    ...
    <div id="adding_type" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ {{ $data->search_type }} || 유형 수정</strong></h1>
            <form id="adding_type-form" method="POST" action="{{ route('admin.adding_type.update', $data->search_type_id) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="search_type_id" name="search_type_id" class="form-control"
                                       value="{{ old('search_type_id',$data->search_type_id) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="search_type" name="search_type" class="form-control"
                                       ...
                                       value="{{ old('search_type',$data->search_type)}}">
